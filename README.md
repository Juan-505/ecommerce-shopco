...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/axyl1410/ecommerce-shopco.git
   cd ecommerce-shopco
   ```
...
Feel free to submit issues for any bugs, feature requests, or general questions related to the project. You can also reach out via [email](mailto:truonggiang.axyl@gmail.com) for support.
